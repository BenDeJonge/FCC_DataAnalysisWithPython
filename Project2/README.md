...
* How many people of each race are represented in this dataset? This should be
  a Pandas series with race names as the index labels. (`race` column)
...
Use the starter code in the file `demographic_data_analyzer`. Update the code
